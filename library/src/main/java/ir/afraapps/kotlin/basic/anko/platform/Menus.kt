 ...
 */
fun Menu.item(/*@StringRes*/ titleRes: Int, /*@DrawableRes*/ icon: Int = 0, checkable: Boolean = false): MenuItem =
    add(titleRes).apply {
        setIcon(icon)
        isCheckable = checkable
    }
 ...
 */
fun Menu.navigationItem(title: CharSequence, /*@DrawableRes*/ icon: Int = 0): Unit {
    add(title).apply {
        setIcon(icon)
        isCheckable = true
    }
