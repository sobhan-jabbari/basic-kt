...
abstract class BaseAdapterPagedListEndless<I>(diffCallback: DiffUtil.ItemCallback<I>) :
    BaseAdapterPagedList<I>(diffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder<AnkoUI> {
        ...
        else onCreateViewHolder(parent.context, viewType)
    }
