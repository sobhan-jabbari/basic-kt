...
fun <T : View> ViewGroup.include(view: T): T = include(view, {})
inline fun <T : View> ViewGroup.include(view: T, init: (@AnkoViewDslMarker T).() -> Unit): T {
    return ankoView({ ctx -> view }, 0) { init() }
}
